...
export class Backend implements backendInterface {
    ...
    async addBook(arg0: string, arg1: string, arg2: string): Promise<bigint> {
    ...
    async addService(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllServices(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getLibraryInfo(): Promise<LibraryInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.getLibraryInfo();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBook(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateLibraryInfo(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLibraryInfo(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateService(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
